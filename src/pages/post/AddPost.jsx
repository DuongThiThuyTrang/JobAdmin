    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errs).length === 0) {
            ...
            try {
                ...
                // console.log("idOccupation: " + idOccupation);
                        ...
                        <div className="post2Right">
                            <div className="salary2">
                                ...
                                <select value={selected} className="dropdown" onChange={(e) => setSelected(e.target.value)}>
                                    ...
                                    {/* <option value="64100616fdd527b2f096944a">IT </option>
                                    <option value="6410061cfdd527b2f096944c">Back-end </option>
                                    <option value="64100622fdd527b2f096944e">Front-end </option>
                                    <option value="6410065cfdd527b2f0969450">DevOps </option>
                                    <option value="64100664fdd527b2f0969452">System Admin </option>
                                    <option value="6410066bfdd527b2f0969454">BA </option>
                                    <option value="64100672fdd527b2f0969456">Data Engineer </option>
                                    <option value="64100677fdd527b2f0969458">Data Analyst </option>
                                    <option value="64100682fdd527b2f096945a">Data Scientist </option>
                                    <option value="6410068ffdd527b2f096945c">Design </option>
                                    <option value="647c5685ccd230515fd802c9">AI </option> */}
                                    {optionList.map((m) =>
