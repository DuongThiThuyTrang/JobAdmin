				...
				<div className={cx("CompanyInfo")}>
					<a href="/vn">
						<div className={cx("BrandContainer", "Logo")} role="presentation" tabIndex={0}>
							<img className={cx("BrandImage")} src="/static/images/logo.png" alt="" tabIndex={-1} />
						</div>
					</a>
					<h4 className={cx("RegionalHeading")}>
						Job-Finder Asia Pacific
					</h4>
					...
					<nav className={cx("Social")}>
						<a title="facebook" href="#" target="_blank" rel="nofollow noopener noreferrer">
						...
						<a title="twitter" href="#" target="_blank" rel="nofollow noopener noreferrer">
						...
						<a title="instagram" href="#/" target="_blank" rel="nofollow noopener noreferrer">
						...
						<a title="linkedin" href="#" target="_blank" rel="nofollow noopener noreferrer">
						...
						<a title="email" href="#" target="_blank" rel="noreferrer">
					...
					<div className={cx("Paragraph", "SmallWhiteText", "Copyright")} color="#FFFFFF">
						© 2025&nbsp;<span className={cx("DisclaimerTitle6")}>CÔNG TY TNHH Job-Finder VIỆT NAM</span>

						<p className={cx("DisclaimerPart")}>Địa chỉ: Đường Z115, Quyết Thắng, Thành Phố Thái Nguyên.
						</p>
						<p className={cx("DisclaimerPart")}>Email:&nbsp;
							<a href="mailto:contact@ictu.edu.vn">contact@ictu.edu.vn</a>
						</p>
						<p className={cx("DisclaimerPart")}>Hotline:&nbsp;
							<a href="tel:(0208) 3846254">(0208) 3846254</a>
						</p>
					</div>
				</div>
